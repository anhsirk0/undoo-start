...
** Chromium
Switch to the =chromium-extension= repo and download the code
  - [[https://codeberg.org/anhsirk0/undoo-start-chromium][chromium-extension repo on codeberg]]
  - [[https://github.com/anhsirk0/undoo-start-chromium][chromium-extension repo on github]]
...
*** Source code
  - [[https://codeberg.org/anhsirk0/undoo-start-firefox][firefox-extension repo on codeberg]]
  - [[https://github.com/anhsirk0/undoo-start-firefox][firefox-extension repo on github]]
* Development
