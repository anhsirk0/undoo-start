...
Switch to the =pages= branch and download the code
[[https://codeberg.org/anhsirk0/undoo-start/src/branch/pages][pages branch on codeberg]] 
[[https://github.com/anhsirk0/undoo-start/tree/pages][pages branch on github]] 
