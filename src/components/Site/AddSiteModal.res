...
let make = (~site: option<Shape.Site.t>, ~onClose, ~onSubmit) => {
  ...
  <Modal
    ...
    onClose
    classes="min-w-[80vw] xl:min-w-[64vw] max-h-[99vh] min-h-0">
    <form onSubmit=handleSubmit className="flex flex-col gap-2 xl:gap-4 min-h-0" tabIndex=0>
      <div className="flex flex-col lg:flex-row gap-4 2xl:gap-8 min-h-0">
        <div className="flex flex-col gap-2 xl:gap-4 min-w-[45%] shrink-0 h-full min-h-0">
