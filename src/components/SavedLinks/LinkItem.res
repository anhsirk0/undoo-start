...
let make = (~link: Shape.Link.t) => {
  ...
  isEditing
    ...
    : <a
        ...
        <div
          className="flex flex-row rounded-btn bg-neutral text-neutral-content h-8 xxl:h-12 items-center">
          <img
            alt=link.title
          ...
          <div
            onClick={stopEvent}
            className="absolute top-0 right-0 hidden group-hover:flex xxl:p-2 h-full bg-neutral rounded-btn">
